...
export default class TrainingAndQualificationsController {
  ...
  public get: RequestHandler = async (req, res, next): Promise<void> => {
    ...
    try {
      ...
      const backLocation = getBackLocation({
        ...
        defaultRoute:
          mode === 'new'
            ? addressLookup.workReadiness.createProfile.workExperience(id, mode)
      ...
      res.render('pages/workReadiness/createProfile/trainingAndQualifications/index', { ...data })
    } catch (err) {
      next(err)
    }
  }
  ...
  public post: RequestHandler = async (req, res, next): Promise<void> => {
    ...
    try {
      ...
      if (errors) {
        res.render('pages/workReadiness/createProfile/trainingAndQualifications/index', {
          ...data,
          errors,
          trainingAndQualifications,
          trainingAndQualificationsDetails,
