...
context('SignIn', () => {
  ...
  it('No right to work', () => {
    ...
    cy.task('getAllOffenderManagers', 'G6115VJ')
  ...
  it('Support Needed', () => {
    ...
    cy.task('getAllOffenderManagers', 'H4115SD')
  ...
  it('No support needed', () => {
    ...
    cy.task('getAllOffenderManagers', 'G5005GD')
  ...
  it('No profile found', () => {
    ...
    cy.task('getAllOffenderManagers', 'A00001A')
