...
context('SignIn', () => {
  ...
  it('Validation messages display when no value selected', () => {
    ...
    workExperience
      ...
      .contains('Select if Test User1 has any work or volunteering experience or not')
    workExperience
    ...
    workExperience.detailsPageErrorMessage().contains("Enter details of Test User1's work or volunteering experience")
    workExperience.detailsFieldErrorMessage().contains("Enter details of Test User1's work or volunteering experience")
  })
